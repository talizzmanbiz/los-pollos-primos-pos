        ...
        <div className="site-container grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-2 text-sm text-brand-100/80">
              ...
              {site.facebook && (
                <li>
                  <a href={site.facebook} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center transition hover:text-white">
                    Facebook
                  </a>
                </li>
              )}
              {site.instagram && (
                <li>
                  <a href={site.instagram} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center transition hover:text-white">
                    Instagram
                  </a>
                </li>
              )}
